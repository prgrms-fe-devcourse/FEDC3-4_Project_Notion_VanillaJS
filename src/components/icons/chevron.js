...
const Chevron = ({ color = 'rgba(55,53,47,0.35)', rotateDegree = DEGREE.CLOSED }) => {
  return `
    <svg
      class='chevron'
      viewBox='0 0 12 12'
      style='width: 0.8rem; height: 1rem; display: block; flex-shrink: 0; backface-visibility: hidden; transition: transform 200ms ease-out 0s; transform: rotateZ(${rotateDegree}deg); opacity: 1;'
    >
      <path 
